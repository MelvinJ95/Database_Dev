angular.module('AppChat').controller('DislikesController', ['$http', '$log', '$scope', '$rootScope', '$location','$routeParams',
    function($http, $log, $scope, $rootScope, $location,$routeParams)  {
        ...
        this.showDislikes = function(){
            ...
            var url = "http://localhost:5000/GramChat/reactions/getDislikes/" + thisCtrl.pid;
